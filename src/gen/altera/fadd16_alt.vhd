...
entity fadd16_alt is
	port (
		clk    : in  std_logic                     := '0';             --    clk.clk
		areset : in  std_logic                     := '0';             -- areset.reset
		a      : in  std_logic_vector(15 downto 0) := (others => '0'); --      a.a
		b      : in  std_logic_vector(15 downto 0) := (others => '0'); --      b.b
		q      : out std_logic_vector(15 downto 0)                     --      q.q
	);
end entity fadd16_alt;

architecture rtl of fadd16_alt is
	component fadd16_alt_0002 is
		port (
	...
	end component fadd16_alt_0002;

begin

	fadd16_alt_inst : component fadd16_alt_0002
		port map (
			clk    => clk,    --    clk.clk
...
end architecture rtl; -- of fadd16_alt
...
-- IPFS_FILES : fadd16_alt.vho
-- RELATED_FILES: fadd16_alt.vhd, dspba_library_package.vhd, dspba_library.vhd, fadd16_alt_0002.vhd
