...
end entity fconv16_alt;

architecture rtl of fconv16_alt is
	component fconv16_alt_0002 is
		port (
	...
	end component fconv16_alt_0002;

begin

	fconv16_alt_inst : component fconv16_alt_0002
		port map (
			clk    => clk,    --    clk.clk
...
end architecture rtl; -- of fconv16_alt
...
-- IPFS_FILES : fconv16_alt.vho
-- RELATED_FILES: fconv16_alt.vhd, dspba_library_package.vhd, dspba_library.vhd, fconv16_alt_0002.vhd
