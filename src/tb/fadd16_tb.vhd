...
architecture sim of fadd16_tb is
...
entity fadd16_1_tb is end entity;
architecture sim of fadd16_1_tb is
begin
  dut : entity work.fadd16_tb generic map (1);
end architecture;

entity fadd16_4_tb is end entity;
architecture sim of fadd16_4_tb is
begin
  dut : entity work.fadd16_tb generic map (4);
end architecture;

entity fadd16_12_tb is end entity;
architecture sim of fadd16_12_tb is
begin
  dut : entity work.fadd16_tb generic map (12);
end architecture;
