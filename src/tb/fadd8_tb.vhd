...
-- Description:             Testbench for floating point addition with generic
--                          pipeline depth.
-- =============================================================================
...
architecture sim of fadd8_tb is
  constant CLK_PERIOD : delay_length := 20 ns; -- 50 MHz
  signal clk, done : std_logic := '0';

  signal a, b, y : std_logic_vector(7 downto 0) := (others => '0');
...
entity fadd8_1_tb is end entity;
architecture sim of fadd8_1_tb is
begin
  dut : entity work.fadd8_tb generic map (1);
end architecture;

entity fadd8_4_tb is end entity;
architecture sim of fadd8_4_tb is
begin
  dut : entity work.fadd8_tb generic map (4);
end architecture;

entity fadd8_12_tb is end entity;
architecture sim of fadd8_12_tb is
begin
  dut : entity work.fadd8_tb generic map (12);
end architecture;
