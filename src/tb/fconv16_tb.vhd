...
entity fconv16_tb is
  generic (
    N_STAGES : natural := 1
  );
end entity;

architecture sim of fconv16_tb is
...
entity fconv16_1_tb is end entity;
architecture sim of fconv16_1_tb is
begin
  dut : entity work.fconv16_tb generic map (1);
end architecture;

entity fconv16_4_tb is end entity;
architecture sim of fconv16_4_tb is
begin
  dut : entity work.fconv16_tb generic map (4);
end architecture;

entity fconv16_12_tb is end entity;
architecture sim of fconv16_12_tb is
begin
  dut : entity work.fconv16_tb generic map (12);
end architecture;
